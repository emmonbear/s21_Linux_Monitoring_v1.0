...
set_color () {
  ...
  local text_black="30"
  local text_default="33;1"

  local param_1=$column1_background
  local param_2=$column1_font_color
  local param_3=$column2_background
  local param_4=$column2_font_color
  ...
  case $param_1 in
    ...
    0) background_1=$background_default;;
  esac
  ...
  case $param_3 in
    ...
    0) background_2=$background_default;;
  esac
